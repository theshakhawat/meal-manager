...
<body
    ...
    <div
        class="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-xl sm:shadow-2xl border border-slate-100 dark:border-zinc-800/80 p-6 sm:p-8 transition-colors">
        ...
        <div class="text-center mb-6 sm:mb-8">
            ...
            <h2 class="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Welcome back</h2>
            <p class="text-xs sm:text-sm text-slate-500 dark:text-zinc-400 mt-1">Sign in to access your account</p>
        </div>
        ...
        @if (session('success'))
            <div
                ...
                <i class="fa-solid fa-circle-check text-brand-600 dark:text-brand-500 mt-0.5 text-base"></i>
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-4">
            ...
            <div class="flex items-center justify-between text-xs sm:text-sm pt-1">
                <label class="flex items-center cursor-pointer select-none">
                    ...
                    <span class="ml-2 text-xs text-slate-600 dark:text-zinc-400">Remember me</span>
                </label>
                <a href=""
                    class="text-xs font-semibold text-brand-800 dark:text-brand-500 hover:underline">Forgot
                    password?</a>
            ...
            <p class="mt-4 text-center text-xs sm:text-sm text-slate-600 dark:text-zinc-400">
                Don't have an account?
                <a href="{{ route('register') }}"
                    class="font-semibold text-brand-800 dark:text-brand-500 hover:underline">Sign up</a>
        </form>
    </div>
